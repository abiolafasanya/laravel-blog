<x-layout>
    <section class="container mx-auto mt-12">
        ...
        @if ($articles->count() < 1)
            <div class="alert text-dark max-w-6xl md:max-w-xl text-center mx-auto bg-gray-200 border border-gray-300"><i class="fa fa-info-circle" aria-hidden="true"></i> No articles found</div>
        @else
                ...
                @foreach ($articles as $article)
                    <article class="card">
                        ...
                        <section class="p-5">
                            ...
                            <a class="link" href="{{ route('articles.show', $article->id) }}">{{ $views }}<i
